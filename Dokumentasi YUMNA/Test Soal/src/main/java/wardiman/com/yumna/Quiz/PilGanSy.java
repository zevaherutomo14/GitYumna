...
public class PilGanSy extends AppCompatActivity {
    ...
    private void setonten() {
        ...
        if (x >= arr){
            ...
            mtvSoal.setText(soalPG.getSyahadat(x));
            mrbJawaban1.setText(soalPG.getPilJwbSy1(x));
            mrbJawaban2.setText(soalPG.getPilJwbSy2(x));
            mrbJawaban3.setText(soalPG.getPilJwbSy3(x));
            jawaban = soalPG.getJwbBnrSyahadat(x);
        }
        x++;
    }
    ...
    private void cekJawaban() {
        if (mrbJawaban1.isChecked()){
            if (mrbJawaban1.getText().toString().equals(jawaban)){
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(PilGanSy.this);
