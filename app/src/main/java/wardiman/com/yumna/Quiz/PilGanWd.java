...
public class PilGanWd extends AppCompatActivity {
    ...
    private void setonten() {
        ...
        if (x >= arr){
            ...
            Intent intent = new Intent(PilGanWd.this,SkorWdActivity.class);
            intent.putExtra("skorAkhir", jumlahSkor);
            intent.putExtra("activity", "PilihanGanda");
            startActivity(intent);
        } else {
            mtvSoal.setText(soalPG.getWudhu(x));
            mrbJawaban1.setText(soalPG.getPilJwbWd1(x));
            mrbJawaban2.setText(soalPG.getPilJwbWd2(x));
            mrbJawaban3.setText(soalPG.getPilJwbWd3(x));
            jawaban = soalPG.getJwbBnrWudhu(x);
        }
        x++;
    }
    ...
    private void cekJawaban() {
        if (mrbJawaban1.isChecked()){
            if (mrbJawaban1.getText().toString().equals(jawaban)){
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(PilGanWd.this);
